...
function About() {
  ...
  <main className={styles.main}>
    ...
    <div className={styles.container}>
      ...
      Not so long ago I started my career as PO in health tech. I knew I didn't want to spend my time working for
      companies which build products that just waste people's time - like mobile games.
      <br />
      Instead, I wanted to help fantastic teams to build great products which leave a positive impact on people's lives🐱‍💻.
      <br /><br />
      </p>
      <p className={styles.description}>
      ...
      <p className={styles.description}>
      And that's a problem for anyone who wants to f(o)und a health tech startup: Suddenly, so many regulatory requirements apply to you.
      </p>
      <p className={styles.description}>
      And the toughest part isn't even to implement these requriements. But just to understand which of them apply in the first place and
      ...
      bit (literally 😄). For example, I've never seen any "Datenschutzfolgenabschätzung" that actually led to a new feature being developed, which actually helps making your user's health data more secure.
      <br /><br />
      </p>
      <p className={styles.description}>
